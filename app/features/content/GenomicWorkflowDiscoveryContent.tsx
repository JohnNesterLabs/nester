export default function GenomicWorkflowDiscoveryContent() {
    return (
      <>
        ...
        <h3>The Challenge</h3>
        <p>Researchers often encounter significant obstacles in genomic data analysis due to the intricate nature of Next-Generation Sequencing (NGS) workflows and the requisite coding expertise. Traditional platforms typically necessitate transferring sensitive genomic data into vendor-hosted environments, raising concerns about data security and compliance. Moreover, the absence of intuitive interfaces impedes collaboration between bench scientists and bioinformaticians, resulting in inefficiencies and delays in research and development.
       </p>
       <img src="/genomics/g1.avif" alt="genomics visuals frame 1" />
  
       <h3>The Solution</h3>
        <p>Basepair addresses these challenges by offering a cutting-edge platform that simplifies and accelerates genomic data analysis. Its user-friendly, point-and-click interface enables researchers to perform complex analyses, such as whole genome and exome sequencing, without the need for coding skills. By integrating with AWS HealthOmics and GPU-accelerated tools like NVIDIA Parabricks, Basepair ensures secure, scalable, and efficient data processing within the user’s own AWS environment, eliminating the need to move data into external hosted solutions.
